...
public class Test1 extends TestObject {
   ...
   public boolean run() {
      ...
      placePieceExpectFail(playerOnePieces.get(0), new Coordinate(-1,0), players.get(0), new int[] {-1,0,0,0});
      
      // Adding P1-QNB to 1,0 should fail
      placePieceExpectFail(playerOnePieces.get(0), new Coordinate(1,0), players.get(0), new int[] {-1,0,0,0});
      
      // Adding P2-QNB to 1,0 should fail
      placePieceExpectFail(playerTwoPieces.get(0), new Coordinate(1,0), players.get(1), new int[] {-1,0,0,0});
      
      // Adding P2-BTL to 1,0 should fail
      placePieceExpectFail(playerTwoPieces.get(1), new Coordinate(1,0), players.get(1), new int[] {-1,0,0,0});
