...
public class Test2 extends TestObject {
   ...
   public boolean run() {
      ...
      movePieceExpectSuccess(playerOnePieces.get(1), new Coordinate(1,0), new Coordinate(0, -1), players.get(0), new int[] {-1,0,-1,1});
      
      System.out.println("2ND");
      // Adding P2-BTL to -2,1 should succeed
      placePieceExpectSuccess(playerTwoPieces.get(2), new Coordinate(-2,1), players.get(1), new int[] {-2,0,-1,1});
      
      System.out.println("3RD");
      // Moving P1-BTL from 0,-1 to -1,-1 should succeed
      movePieceExpectSuccess(playerOnePieces.get(1), new Coordinate(0,-1), new Coordinate(-1, -1), players.get(0), new int[] {-2,0,-1,1});
      ...
      movePieceExpectSuccess(playerTwoPieces.get(1), new Coordinate(-1,1), new Coordinate(0, 1), players.get(1), new int[] {-2,0,-1,1});
